...
/* 
ORDEM DE REMOÇÃO: 1º AS TABELAS FRACAS E DEPOIS AS FORTES
    COMO É O O SCRIPT:
        * INICIO: TABELAS COM MAIS DE UMA FK
        * MEIO: TABELAS COM PK E FK
        * FIM: TABELAS COM PK
ORDEM DE CRIAÇÃO: 1º AS TABELAS FORTES E DEPOIS AS FRACAS
    COMO É O O SCRIPT:
        * INICIO: TABELAS COM PK
        * MEIO: TABELAS COM PK E FK
        * FIM: TABELAS COM MAIS DE UMA FK

TABELA FORTE: É AQUELA QUE PERMITE O RELACIONAMENTO E NORMALMENTE TEM APENAS A PKs
TABELA FRACA: É AQUELA QUE RECEBE O RELACIONAMENTO E NORMALMENTE TEM UMA OU MAIS FKs
*/
-- CRIANDO TABELAS
